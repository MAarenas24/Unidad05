...
/**
 * Pedir por teclado el numero de elemenots del array
 * El array podra añadir elementos (por el final) o insertarlos (por el
 * principio).
 * Si el array esta lleno, no admitira mas numeros
...
public class MiArray {
    ...
    public void insertar(int numAlAprincipio, int posicion) {
        if (estaLleno()) {
            System.out.printf("El numero %d no se ha insertado. El array esta lleno", numAlAprincipio);
            return;
        }
    }
